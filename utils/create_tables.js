const createTablesIfNotExists = (db) => {
    ...
    CONSTRAINT admin_password_key UNIQUE (password))`);
    ...
    division_id character varying(20) COLLATE pg_catalog."default" NOT NULL,
    ...
    CONSTRAINT division_user_admin_id_key UNIQUE (admin_id),
    CONSTRAINT division_user_division_key UNIQUE (division),
    CONSTRAINT division_user_email_key UNIQUE (email),
    CONSTRAINT division_user_password_key UNIQUE (password),
    ...
    CONSTRAINT institution_user_division_id_key UNIQUE (division_id),
    ...
    khatha_or_property_no character varying(20) COLLATE pg_catalog."default" NOT NULL,
    name_of_khathadar character(20) COLLATE pg_catalog."default" NOT NULL,
    type_of_site character(20) COLLATE pg_catalog."default",
    CONSTRAINT site_user_pkey PRIMARY KEY (site_id),
    CONSTRAINT site_user_division_id_key UNIQUE (division_id),
    CONSTRAINT site_user_khatha_or_property_no_key UNIQUE (khatha_or_property_no),
    CONSTRAINT site_user_name_of_khathadar_key UNIQUE (name_of_khathadar),
    ...
    CONSTRAINT site_user_division_id_fkey FOREIGN KEY (division_id)
        ...
        db.query(`
        CREATE SEQUENCE IF NOT EXISTS public.payment_details_sl_no_seq
        START WITH 1
        INCREMENT BY 1
        NO MINVALUE
        NO MAXVALUE
    ...
    sl_no integer NOT NULL DEFAULT nextval('payment_details_sl_no_seq'::regclass),
    institution_id character varying(20) COLLATE pg_catalog."default" NOT NULL,
    site_id character varying(20) COLLATE pg_catalog."default" NOT NULL,
    ...
    CONSTRAINT payment_details_pkey PRIMARY KEY (sl_no),
    ...
    CONSTRAINT bills_sl_no_key UNIQUE (sl_no),
